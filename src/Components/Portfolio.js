          ...
          <div key={projects.title} className="columns portfolio-item">
            <div className="item-wrap">
              <a href={projects.url} title={projects.title}>
                <img alt={projects.title} src={projectImage} onError={(e) => { e.target.onerror = null; e.target.src = "images/portfolio/placeholder.png"; }} />
        ...
        <div className="row">
          <div className="twelve columns collapsed">
            ...
            <div
              ...
              className="bgrid-thirds s-bgrid-halfs cf"
            >
              {projects}
            </div>
          </div>
